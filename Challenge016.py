...
question1 = input("Is raining today?: [yes or no] ")

if question1.lower() in ['yes']:
    question2 = input("Is windy today? [yes or no] ")
    if question2.lower() in ['yes']:
        print("It is to windy for an unmrella")
    elif question2.lower() in ['no']:
